...
<div class="publication-list" markdown="1">
- \[C9\] Shangkun Li, Jinming Ge, Diyuan Tao, Zeyu Li, **Jiawei Liang**, Linfeng Du, Jiang Xu, Wei Zhang, and Cheng Tan. "NEURA: A Unified and Retargetable Compilation Framework for Coarse-Grained Reconfigurable Architectures", PLDI, 2026. [PDF](https://dl.acm.org/doi/abs/10.1145/3808285)
- \[C8\] Shangkun Li, Cheng Tan, Zeyu Li, Jinming Ge, **Jiawei Liang**, Hao Yang, Linfeng Du, Jiang Xu, Wei Zhang. "A Cluster-Based Distributed Memory Architecture for CGRAs", DATE, 2026. [PDF](https://ieeexplore.ieee.org/abstract/document/11539358)
- \[C7\] Xingyu Liu, **Jiawei Liang**, Yipu Zhang, Linfeng Du, Chaofang Ma, Hui Yu, Jiang Xu and Wei Zhang. "DRACO: A Hardware-Efficient Robot Rigid Body Dynamics Accelerator with Precision-Aware Quantization Framework", HPCA, 2026.[PDF](https://ieeexplore.ieee.org/abstract/document/11408528)
